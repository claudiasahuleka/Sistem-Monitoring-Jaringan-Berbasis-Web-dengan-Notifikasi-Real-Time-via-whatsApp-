...
<div class="d-flex justify-content-between mb-3">
    <h4><i class="bi bi-plus-circle"></i> Tambah Perangkat</h4>
        ...
        <form action="{{ route('devices.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                    value="{{ old('name') }}" placeholder="Contoh: Router Lantai 1" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="location" class="form-control"
                    value="{{ old('location') }}" placeholder="Contoh: Ruang Server Lantai 2">
            </div>
            <div class="mb-3">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" name="congestion_threshold_ms"
                        ...
                        value="{{ old('congestion_threshold_ms', 150) }}"
                        min="30" max="2000">
                    <div class="form-text">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="congestion_check_count"
                        class="form-control form-control-sm"
                        value="{{ old('congestion_check_count', 5) }}"
                        min="3" max="20">
                    <div class="form-text">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="bi bi-save"></i> Simpan Perangkat
            </button>
        </form>
    </div>
</div>
